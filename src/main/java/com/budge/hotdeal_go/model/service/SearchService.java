...
public interface SearchService {
    ...
    List<HotDealDto> getListAll(int pgno, int npp) throws SQLException;

    // 해당 커뮤니티에서 핫딜 정보를 가져오는 함수
    List<HotDealDto> getHotDealInfoBySiteName(int pgno, int npp, List<String> siteNames)
            throws SQLException;
    ...
    List<HotDealDto> getListBySiteName(String title, List<String> siteNames, int pgno, int npp)
            throws SQLException;
